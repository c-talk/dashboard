...
async function rollupBuild(ctx) {
  if (ctx.options.stub) {
    const jitiPath = await (0, _mlly.resolvePath)("jiti", { url: "file:///root/Programs/c-talk/dashboard/node_modules/.pnpm/unbuild@2.0.0_typescript@5.3.3/node_modules/unbuild/dist/index.mjs" });
